describe("TimeLostSolver", function()
	...
	it("BuildTimeLostTestItem honors radius label", function()
		...
		local veryLarge = TradeQueryGeneratorClass.BuildTimeLostTestItem("Time-Lost Sapphire", "Very Large")
		assert.is_truthy(small.jewelRadiusIndex)
		assert.is_truthy(medium.jewelRadiusIndex)
		assert.is_truthy(large.jewelRadiusIndex)
		assert.is_truthy(veryLarge.jewelRadiusIndex)
		...
		assert.are_not.equal(large.jewelRadiusIndex, veryLarge.jewelRadiusIndex)
	end)
