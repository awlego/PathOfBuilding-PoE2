...
-- Hidden attack stub used by the ConspiracyRavenFlock minion (Spiraling Conspiracy).
skills["ConspiracyFlockAura"] = {
	name = "Flock",
	hidden = true,
	skillTypes = { [SkillType.Attack] = true, [SkillType.Area] = true, [SkillType.Melee] = true, [SkillType.Physical] = true, [SkillType.Chaos] = true, [SkillType.AttackInPlace] = true, },
	castTime = 1,
	qualityStats = {
	},
	levels = {
