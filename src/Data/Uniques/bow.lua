...
{variant:1}Attacks with this Weapon gain 50% of Physical damage as Extra damage of each Element
{variant:2}Attacks with this Weapon gain 100% of Physical damage as Extra damage of each Element
]],[[
Fairgraves' Curse
Artillery Bow
...
Variant: Pre 0.4.0
Variant: Current
{variant:1}Adds 1 to (200-300) Lightning Damage
{variant:2}Adds 1 to (300-500) Lightning Damage
