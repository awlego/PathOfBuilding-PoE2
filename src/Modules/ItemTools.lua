...
function itemLib.formatModLine(modLine, dbMode)
	...
	if modLine.extra then
		...
		colorCode = (modLine.enchant and colorCodes.ENCHANTED) or (modLine.fractured and colorCodes.FRACTURED) or (modLine.mutated and colorCodes.MUTATED) or (modLine.custom and colorCodes.CUSTOM) or (modLine.desecrated and colorCodes.DESECRATED) or colorCodes.MAGIC
	end
